...
class QueueDifferTest {
	
	private static <E> Queue<E> asQueue(E... elements) {
		return new ArrayDeque<>(asList(elements));
	}
	...
	static Object[][] diff_data() {
		...
		return new Object[][] {
				{
						asQueue(testData.country1, testData.country2, testData.country3),
						asQueue(testData.country2, testData.country1, testData.country3),
				...
				{
						asQueue(testData.country1),
						asQueue(testData.country1, testData.country2),
						asHashSet(new IndexedDiff<>(HELD, testData.country1, testData.country1)
				...
				// ... one removed
				{
						asQueue(testData.country1, testData.country2, testData.country1),
						asQueue(testData.country1),
						asHashSet(new IndexedDiff<>(HELD, testData.country1, testData.country1)
										.addSourceIndex(0).addReplacerIndex(0),
								new IndexedDiff<>(REMOVED, testData.country2, null)
				...
				{
						asQueue(testData.country1, testData.country2, testData.country1),
						asQueue(testData.country1, testData.country1),
						asHashSet(new IndexedDiff<>(HELD, testData.country1, testData.country1)
				...
				{
						asQueue(testData.country1, testData.country2, testData.country1),
						asQueue(testData.country1, testData.country1, testData.country1, testData.country1),
						asHashSet(new IndexedDiff<>(HELD, testData.country1, testData.country1)
										.addSourceIndex(0).addSourceIndex(2).addReplacerIndex(0).addReplacerIndex(1),
				...
				{
						asQueue(testData.country1, testData.country2, testData.country1),
						asQueue(testData.country1, testData.country1, testData.country1, testData.country1, testData.country2, testData.country2),
						asHashSet(new IndexedDiff<>(HELD, testData.country1, testData.country1)
										.addSourceIndex(0).addSourceIndex(2).addReplacerIndex(0).addReplacerIndex(1),
								new IndexedDiff<>(ADDED, null, testData.country1)
										.addReplacerIndex(2).addReplacerIndex(3),
	...
	void diff(Queue<Country> set1, Queue<Country> set2, Set<IndexedDiff<Country>> expectedResult) {
		QueueDiffer<Country, Long> testInstance = new QueueDiffer<>(Country::getId);
	...
	void diff_withClone_cloneMustBeReplacingInstance() {
		...
		Queue<Country> set1 = new ArrayDeque<>(asQueue(testData.country1, testData.country2, testData.country3));
		Queue<Country> set2 = new ArrayDeque<>(asQueue(testData.country2, country1Clone, testData.country3));
		
		QueueDiffer<Country, String> testInstance = new QueueDiffer<>(Country::getName);	// we use a different predicate to prevent from using same comparator that equals(..) method
		Set<IndexedDiff<Country>> diffs = testInstance.diff(set1, set2);
