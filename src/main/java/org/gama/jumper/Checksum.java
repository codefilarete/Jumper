...
/**
 * A container for a MD5, SHA1, version, ... whatever that can represent a "signature" of an {@link Update}.
 * 
 ...
 * - reused {@link UpdateId} between two {@link Update}s
 * - code changes made by developpers on {@link Update}s that were already run on target environment
 * 
