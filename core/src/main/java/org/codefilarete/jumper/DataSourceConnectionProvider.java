 ...
 */
public class DataSourceConnectionProvider implements SeparateConnectionProvider {
	...
	@Override
	public Connection giveSeparateConnection() {
	...
	private Connection lookupForConnection() {
		...
		try {
			...
			throw new RuntimeException("Error while trying to get connection from DataSource", e);
		}
		return connection;
	}
