...
public class ExportedKeysMetadataReader extends AbstractMetadataReader {
	...
	private static final String INDEX_SELECT_SQL_BASE = "SELECT NULL PKTABLE_CAT, KCU.REFERENCED_TABLE_SCHEMA PKTABLE_SCHEM, KCU.REFERENCED_TABLE_NAME PKTABLE_NAME,"
	...
	public ResultSet giveMetaData(Operator schema, Operator tableNamePattern)
		...
		indexSelectSQL.append(" ORDER BY FKTABLE_CAT, FKTABLE_SCHEM, FKTABLE_NAME, KEY_SEQ");
